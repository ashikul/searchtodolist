(function (window) {
  ...
  function Controller(model, view) {
    ...
    self.view.bind('searchAll', function () {
      self.searchAll();
    });
  ...
  Controller.prototype.searchAll = function () {
    ...
    self.model.read({
      ...
      data.forEach(function (item) {
        var searchBaseUrl = 'https://www.google.com/search?q='
        var query = item.title;
        var newURL = searchBaseUrl + query;
        chrome.tabs.create({
          url: newURL
        });
        // console.log(item);
